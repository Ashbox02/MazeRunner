const { NUM_TILES_HEIGHT, NUM_TILES_WIDTH } = require("../../../Constants/constantServer.js");
const Stack = require("./stack.js");
const Cell = require("./cell.js");

class Maze {
    constructor(NUM_TILES_WIDTH, NUM_TILES_HEIGHT) {
    ...
    dfs(maze, visited, row, col, stack) {
        ...
        if (validNeighbors.length > 0) {
            let random = validNeighbors[Math.floor((Math.random() * validNeighbors.length))];
